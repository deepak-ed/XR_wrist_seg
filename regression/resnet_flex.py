...
def myresnet18(*, weights:[] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def myresnet34(*, weights:[] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def myresnet50(*, weights: Optional[ResNet50_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def myresnet101(*, weights: Optional[ResNet101_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def myresnet152(*, weights: Optional[ResNet152_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
